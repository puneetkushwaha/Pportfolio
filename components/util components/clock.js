...
export default class Clock extends Component {
    ...
    render() {
        ...
        let full_date = day + ", " + date + " " + month + " " + current_time.getFullYear();
        return <span suppressHydrationWarning className="cursor-default select-none hover:text-ub-orange transition-colors duration-200" title={full_date}>{display_time}</span>;
    }
}
